...
def stage_1_msssim(data_dir):
  img_dir = os.path.join(data_dir, 'flowers','jpg')
  gen_img_dir = os.path.join('Data/training/model_14_ds_flowers_stage_1_128'
                             '/msssim/stage_1_ds')
  caption_dir = join(data_dir, 'flowers/set_4')
  ...
  with tf.Session() as sess:
    for class_name in class_dict.keys():
      ...
      real_msssim = []
      fake_msssim = []
      print('calculating MS-SSIM for real images of class : ' + str(class_name))
      ...
      with open('msssim.tsv', 'a') as f:
        ...
        f.write(class_name + '\t' + str_real_mean + '\t' + str_fake_mean +
                '\n')
